    ...
    <div className="success-section">
      ...
      <div className="tables-success">
        ...
        <div className="table-right">
          ...
          <div className="cell">
            <h4>Натпревари за вработување </h4>
            <p>
              * Со компаниите организираме натпревари за вработување за
              студентите кои ќе понудат најдобро решение.
            </p>
          </div>
          <div className="cell">
          ...
          <div className="cell">
            <h4>10x Мега Вештини за успех</h4>
            <p>Лидерство</p>
            <p>
